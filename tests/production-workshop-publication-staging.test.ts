...
import { buildProductionWorkshopPublicationStaging } from "@/lib/production-workshop-publication-staging";

describe("staging Process Production & atelier", () => {
  const entries = buildProductionWorkshopPublicationStaging();
