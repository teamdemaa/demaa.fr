...
import { buildHomeSupportPublicationStaging } from "@/lib/home-support-publication-staging";

describe("staging Process Domicile & accompagnement", () => {
  const entries = buildHomeSupportPublicationStaging();
