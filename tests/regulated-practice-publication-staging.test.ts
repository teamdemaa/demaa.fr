...
import { buildRegulatedPracticePublicationStaging } from "@/lib/regulated-practice-publication-staging";

describe("staging Process Cabinets réglementés", () => {
  const entries = buildRegulatedPracticePublicationStaging();
