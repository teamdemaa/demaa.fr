...
describe("operational system tabs", () => {
  it("keeps Resources inside Solutions instead of exposing a duplicate tab", () => {
  ...
  it("keeps legacy Solutions URLs on Solutions, including before publication", () => {
    ...
    expect(normalizeSystemDetailTab("resources")).toBe("solutions");
    expect(normalizeSystemDetailTab("ressources")).toBe("solutions");
    expect(normalizeSystemDetailTab("modeles")).toBe("solutions");
    expect(normalizeSystemDetailTab("modeles-de-documents")).toBe("solutions");
