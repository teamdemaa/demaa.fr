#!/usr/bin/env python3
"""Build the bold-line illustrations for the first three Course 1 sentences."""
...
PILOT = ROOT / "output" / "course-1-first-three"
PNG_DIR = PILOT / "png"
SVG_DIR = PILOT / "svg"
...
ASSETS = [
    ("01_objectif_commandes_cash", "Tension — commandes pleines, cash faible"),
    ("02_tresorerie_pas_benefice", "Déclic — trésorerie ≠ bénéfice"),
    ("03_rentable_papier_cash_retard", "Risque — rentable, mais trop tard"),
]
...
def build_green_board(images):
    ...
    draw.text((88, 60), "Cours 1 — trois premières phrases", font=font(46, True), fill=WHITE)
    draw.text(
        (90, 126),
    ...
    output = BOARDS_DIR / "course_1_first_three_green.png"
...
def build_contrast_board(images):
    ...
    draw.text(
        (74, 112),
        "Trait plus affirmé • personnage neutre • émotion lisible",
        font=font(18),
        fill=MINT,
    )
    ...
    output = BOARDS_DIR / "course_1_first_three_contrast.png"
    board.save(output, optimize=True)
    return output
