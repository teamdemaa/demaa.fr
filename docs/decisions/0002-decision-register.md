...
| Services V1 | `superseded` | Marketplace de sept services dans le parcours principal | retiré de l'architecture principale | `/services` reste techniquement public pendant l'arbitrage éditorial, mais n'apparaît ni dans la navigation principale ni dans les fiches Système. |
