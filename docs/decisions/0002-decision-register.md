...
- Mise à jour d'état : 14 août 2026, Solutions intégré au Plan et URLs normalisées
...
| Académie D-033/D-036 | `superseded` | Ancienne navigation réciproque et catalogue Académie | remplacé par D-077 et ADR 0004 | L'ancienne navigation limitée à `Système métier / Académie` ne guide plus l'application. L'Académie affiche uniquement `Cours / Ateliers`, avec Cours par défaut ; Ateliers est réservé aux démonstrations pratiques, tandis que Cas concrets et Webinaires restent masqués de l'index sans suppression de leurs routes. |
