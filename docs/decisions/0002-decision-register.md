...
| D-084 | `working` | Stratégie manuelle d'entreprise par cycles | ADR 0013 et programme directeur du 16 août ; décisions produit fermées, implémentation après gate Plans | La nouvelle Stratégie est distincte des plans et de leur historique V3. Elle contient quatre piliers manuels, un cycle actif partagé dans l'entreprise et un historique en lecture seule. Elle n'est jamais synchronisée avec le Plan d'action ni transmise à l'IA. La cible est `/strategie`, immédiatement après Plan d'action ; D-082 reste la navigation Production jusqu'à la fusion complète. Premier cycle automatique, fenêtre de trois mois calendaires Europe/Paris sans expiration, nouveau cycle vide, pagination par 10, accordéon, rétention, conflits inline et suppression par entreprise sont validés. Seuls les gates d'exécution du programme restent applicables. |
