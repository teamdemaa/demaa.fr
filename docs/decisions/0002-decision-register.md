...
| D-078 | `deferred` | Comptes possédant plusieurs entreprises | backlog post-lancement | Prévoir une identité `accountId`, des entreprises isolées côté serveur, des plans et progressions rattachés à une entreprise depuis l'UID Firebase, un sélecteur compact et des tests d'isolation. Le profil entreprise reste facultatif et aucun rôle ou système d'invitation n'est inclus. |
