...
| Académie D-033/D-036 | `superseded` | Ancienne navigation réciproque et catalogue Académie | remplacé par D-077 et ADR 0004 | L'ancienne navigation limitée à `Système métier / Académie` ne guide plus l'application. L'Académie affiche uniquement `Tutoriels / Cours`, avec Tutoriels par défaut ; les identifiants `case-study` restent stables et alimentent les Tutoriels sans quiz, tandis que Webinaires reste masqué. |
