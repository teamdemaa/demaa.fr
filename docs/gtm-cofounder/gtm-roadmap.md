...
**Diagnostic :** l’architecture publique raconte désormais une histoire simple : reprendre, vendre ou avancer avec des ressources. Le prochain enjeu est de transformer cette clarté en projets qualifiés et en mises en relation réelles.
...
- Les formulaires demandent d’abord le besoin, puis les coordonnées.
- Les tests, la vérification TypeScript et la vérification navigateur passent.
...
- Mesurer séparément les demandes de transmission, les estimations et les demandes de préparation opérationnelle.
...
- 2026-09-13 : la marketplace devient la priorité publique ; les opportunités confirmées sont autorisées à la publication.
- 2026-09-13 : la carte, le comparatif, les notifications email et le recentrage du hub Outils sont retenus pour le MVP.
- 2026-09-14 : l’architecture publique devient **À reprendre · Vendre · Ressources**.
