...
| Adresse e-mail redemandée dans chaque formulaire applicatif | `superseded` | authentification Firebase unique, puis e-mail de contact récupéré côté serveur ; l'UID reste la clé d'autorisation |
