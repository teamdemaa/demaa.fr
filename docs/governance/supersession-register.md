...
| ADR 0009 : `Coaching` comme quatrième onglet principal | `superseded` | navigation `Plan d’action / Solutions / Opportunités / Académie`; Coaching reste accessible par `Parler à un spécialiste`, voir ADR 0010 |
