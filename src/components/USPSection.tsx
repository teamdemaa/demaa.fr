...
export default function USPSection() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-10 md:mt-12 animate-in fade-in slide-in-from-top-4 duration-700 delay-300">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 px-6 md:px-8">
        {usps.map((usp, i) => (
          <div key={i} className="flex items-center space-x-5 group md:justify-center">
            <div className="flex-none w-11 h-11 rounded-full bg-white shadow-md border border-brand-coral/15 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="text-[10px] md:text-xs text-gray-400 font-light mt-1 uppercase tracking-tight">
                {usp.subtext}
              </span>
            </div>
          </div>
