...
const transformations = [
  { before: "Informations dispersées", after: "Un suivi centralisé" },
  { before: "Étapes implicites", after: "Un parcours clair" },
  { before: "Relances manuelles", after: "Des actions visibles" },
] as const;

const outcomes = [
  "Les demandes, clients et projets sont suivis au même endroit.",
  "Chaque personne voit sa responsabilité et sa prochaine action.",
  "Les informations circulent sans avoir à être gardées dans votre tête.",
] as const;
    ...
    <>
      ...
      <main className="min-h-screen overflow-x-clip bg-dema-cream text-brand-blue">
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
              <div>
                ...
                <h2 className="mt-4 max-w-3xl text-4xl font-light leading-tight tracking-[-0.04em] sm:text-5xl">L’activité avance, mais tout doit encore passer par vous.</h2>
              </div>
        ...
        <section className="border-b border-dema-line bg-dema-cream px-5 py-16 sm:px-8 sm:py-20 lg:py-24">
          <div className="mx-auto max-w-6xl">
            <p className="text-xs font-medium uppercase tracking-[0.16em] text-dema-forest">Le premier système utile</p>
            <h2 className="mt-4 max-w-3xl text-4xl font-light leading-tight tracking-[-0.04em] sm:text-5xl">Ce que nous mettons en place.</h2>
