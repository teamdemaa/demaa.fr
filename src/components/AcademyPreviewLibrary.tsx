...
export default function AcademyPreviewLibrary({ cards }: { cards: readonly AcademyPreviewCard[] }) {
  ...
  return (
    <div>
      <div className="mx-auto w-full max-w-4xl px-4 sm:px-6">
        <div className="demaa-search-shell">
          <div className="relative">
            ...
            <input type="search" aria-label="Rechercher dans l’Académie" value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Rechercher un sujet…" className="demaa-search-control" />
        ...
        {filtersOpen ? (
          <div className="mt-4 flex flex-wrap gap-2" role="group" aria-label="Filtrer l’Académie par thème">
      ...
      {results.length ? (
        <section aria-label="Contenus de l’Académie" className="px-4 py-14 sm:px-6 md:py-16 lg:px-8">
