...
export default function HeroSearch({ 
  ...
  return (
    <section className="w-full flex flex-col items-center justify-center pt-8 pb-10 md:pt-14 md:pb-16 px-4 text-center bg-[#FFF9F8] border-b border-brand-coral/10">

      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-brand-blue mb-4 md:mb-6 leading-[1.15] max-w-5xl mx-auto z-10 relative px-2">
