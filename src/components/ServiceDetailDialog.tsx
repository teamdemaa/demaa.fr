    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="min-h-0 overflow-y-auto p-4 soft-scroll sm:p-5 md:p-6">
            <p className="max-w-3xl text-[15px] leading-relaxed text-dema-muted sm:text-base">
              {service.description}
            </p>

            <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,0.82fr)]">
              ...
              <aside className="self-start rounded-[1.05rem] border border-dema-line bg-dema-cream/70 p-4 lg:sticky lg:top-0 sm:rounded-[1.15rem] sm:p-5">
