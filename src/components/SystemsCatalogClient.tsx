  ...
  return (
    <>
      <section
        className={
          showIntro
            ? "w-full border-b border-brand-blue/5 bg-[#FFF9F8] px-4 pb-8 pt-10 md:pb-12 md:pt-14"
            : "w-full"
        }
      >
      ...
      {selectedSystem && detail ? (
        ...
        >
          <div
            className="max-h-[92vh] w-full max-w-7xl overflow-y-auto rounded-[2.5rem] bg-[#FFF9F8] p-6 shadow-[0_30px_80px_rgba(25,27,48,0.18)] md:p-8"
