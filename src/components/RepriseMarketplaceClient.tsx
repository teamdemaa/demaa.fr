...
function BuyerRequestForm({ opportunity }: { opportunity: RepriseOpportunity }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-7 grid gap-4 sm:grid-cols-2" noValidate>
      ...
      <label className="block text-sm font-medium sm:col-span-2">Votre projet en quelques mots<textarea className={`${inputClassName} min-h-28 resize-y`} name="message" maxLength={2000} placeholder="Votre expérience, ce que vous souhaitez comprendre et les informations dont vous avez besoin." required /></label>
