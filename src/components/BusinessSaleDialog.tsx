...
export default function BusinessSaleDialog({
  ...
  return (
    <DirectoryDetailDialogShell ariaLabel="Transmettre mon entreprise" maxWidthClassName="max-w-2xl" onClose={onClose}>
      {state === "success" ? (
        ...
        <>
          ...
          <h2 className="mt-3 text-3xl font-medium tracking-[-0.04em] sm:text-4xl">Transmettre mon entreprise.</h2>
