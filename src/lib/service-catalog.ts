...
export const demaaServices = [
  ...
  },
  {
    ...
    category: "Finance",
    shortDescription:
      "Recevez jusqu’à 3 cabinets adaptés à votre activité et à votre situation.",
    description:
      "Votre besoin est qualifié, puis vous recevez jusqu’à trois recommandations de cabinets adaptés. La mise en relation est gratuite.",
    bestFor:
      "Les dirigeants qui recherchent un cabinet pour une création, le suivi courant, la paie, la fiscalité, des formalités ou un changement d’interlocuteur.",
    duration: "Mise en relation",
    price: "Gratuit",
    tags: ["Comptabilité", "Recommandations", "Mise en relation"],
    icon: "Calculator",
    deliverables: [
      "Besoin qualifié par un humain",
      "Jusqu’à 3 cabinets adaptés",
      "Mise en relation gratuite",
    ],
    usefulFor: ["Création", "Comptabilité", "Paie", "Fiscalité", "Formalités"],
  },
  {
    slug: "site-web",
  ...
  },
  {
    ...
    description:
      "Nous adaptons et mettons en place le système opérationnel dans votre environnement : process, rôles, outils, documents, automatisations utiles et prise en main avec l’équipe.",
    bestFor:
      "Les entreprises dont le fonctionnement repose encore trop sur le dirigeant, des informations dispersées ou des habitudes difficiles à transmettre.",
    duration: "Selon le périmètre",
    price: "Sur devis",
    tags: ["Système opérationnel", "Mise en place", "Autonomie"],
    icon: "Workflow",
    deliverables: [
      "Diagnostic de votre fonctionnement",
      "Process, rôles et outils adaptés",
      "Mise en place dans votre environnement",
      "Prise en main avec votre équipe",
    ],
    usefulFor: ["Organisation", "Transmission", "Automatisation", "Autonomie"],
  },
  {
