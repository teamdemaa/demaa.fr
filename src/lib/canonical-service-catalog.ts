...
const canonicalServiceDefinitions = deepFreeze([
  ...
  },
  {
    ...
    summary: "Gagnez du temps au quotidien avec l’automatisation et l’IA.",
    description: "Pendant un mois, nous avançons avec vous sur les priorités qui font perdre du temps à votre équipe, à partir de votre fonctionnement et de vos outils actuels.",
    result: "Des façons de travailler plus claires, des étapes utiles automatisées et une équipe capable de faire évoluer ce qui a été mis en place.",
    delivery: "demaa",
    pricing: null,
    packages: [
      {
        ...
        pricing: { mode: "fixed", amountMinor: AUTOMATION_OFFER.price.amountMinor, currency: AUTOMATION_OFFER.price.currency, heading: "Forfait", label: AUTOMATION_OFFER.price.label, note: "Le programme couvre une entreprise, quatre rendez-vous d’une heure et une équipe projet de une à trois personnes. Les licences et consommations d’outils restent séparées." },
        included: ["Quatre rendez-vous d’une heure", "Des situations réelles traitées ensemble", "Des méthodes réutilisables par l’équipe", "Une à trois personnes participantes"],
      },
    ],
    cta: callback,
    included: ["Quatre rendez-vous d’une heure", "Des situations réelles traitées ensemble", "Des méthodes réutilisables par l’équipe", "Une à trois personnes participantes"],
