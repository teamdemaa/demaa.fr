...
const canonicalServiceDefinitions = deepFreeze([
  ...
  {
    slug: "automatisation-processus", name: AUTOMATION_OFFER.name, eyebrow: `Formation et mentorat · ${AUTOMATION_OFFER.durationLabel}`,
    detailHref: "/automatisation",
    summary: "Faites gagner du temps à vos équipes avec l’automatisation et l’IA.",
    description: `Pendant ${AUTOMATION_OFFER.durationLabel}, vos équipes avancent avec un mentor sur les sujets qui les ralentissent. Les priorités sont choisies au fil des rendez-vous, puis mises en pratique directement dans l’entreprise.`,
    result: "Des automatisations utiles mises en place et des équipes capables de les comprendre, les utiliser et les faire évoluer.",
    delivery: "demaa",
    pricing: null,
    packages: [
      {
        ...
        pricing: { mode: "fixed", amountMinor: AUTOMATION_OFFER.price.amountMinor, currency: AUTOMATION_OFFER.price.currency, heading: "Forfait", label: AUTOMATION_OFFER.price.label, note: "Le programme couvre une entreprise, huit rendez-vous de 45 minutes et douze mois d’accès aux tutoriels. Le paiement peut être réparti en trois fois. Les licences et consommations d’outils restent séparées." },
        included: ["Huit rendez-vous de 45 minutes avec un mentor", "Sujets adaptés aux priorités de l’équipe", "Mise en pratique entre les rendez-vous", "Tutoriels accessibles à toute l’entreprise pendant douze mois"],
      },
    ],
    cta: callback,
    included: ["Huit rendez-vous de 45 minutes avec un mentor", "Sujets adaptés aux priorités de l’équipe", "Mise en pratique entre les rendez-vous", "Tutoriels accessibles à toute l’entreprise pendant douze mois"],
