...
const canonicalServiceDefinitions = deepFreeze([
  ...
  },
  {
    ...
    delivery: "demaa", monthlyAccompanimentDiscountEligible: true,
    pricing: { mode: "fixed", amountMinor: 150000, currency: "EUR", heading: "Forfait", label: "1 500 € HT / mois", note: "Le marché, le volume, les canaux et le niveau de qualification sont cadrés avant le démarrage." },
    cta: callback,
