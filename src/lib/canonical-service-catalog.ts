...
const canonicalServiceDefinitions = deepFreeze([
  ...
  },
  {
    ...
    description: "Pendant 2 mois, nous partons des ressaisies, relances et mises à jour qui ralentissent votre équipe. Nous retenons jusqu’à 3 processus concrets, puis mettons en place les automatisations adaptées avec la personne qui les fera fonctionner au quotidien.",
    ...
    packages: [
      {
        ...
        summary: "Deux mois pour réduire les tâches répétitives et rendre votre équipe autonome sur les automatisations retenues.",
        pricing: { mode: "fixed", amountMinor: 300000, currency: "EUR", heading: "Forfait", label: "3 000 € HT", note: "Le programme couvre une entreprise, un référent principal et un binôme. Le paiement peut être réparti en trois fois. Les licences et consommations d’outils restent séparées." },
        included: ["Diagnostic et priorisation des tâches chronophages", "Cadrage de jusqu’à 3 processus prioritaires", "Mise en œuvre adaptée à leur complexité", "Tests, documentation et transfert de compétences"],
      },
    ],
    cta: callback,
    included: ["Diagnostic et priorisation des besoins", "Cadrage de jusqu’à 3 processus prioritaires", "Mise en œuvre des automatisations adaptées", "Tests, documentation et transfert à un référent"],
