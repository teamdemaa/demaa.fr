...
const canonicalServiceDefinitions = deepFreeze([
  ...
  },
  {
    ...
    summary: "Organisez votre entreprise pour qu’elle dépende moins de vous.",
    description: "Nous clarifions votre fonctionnement et mettons en place les outils, automatisations et usages de l’IA qui vous font gagner du temps.",
    result: "Une organisation plus claire, des éléments utiles mis en place et une équipe capable de faire évoluer ce qui lui est transmis.",
    delivery: "demaa",
    pricing: null,
    packages: [
      {
        ...
        pricing: { mode: "fixed", amountMinor: AUTOMATION_OFFER.price.amountMinor, currency: AUTOMATION_OFFER.price.currency, heading: "Forfait", label: AUTOMATION_OFFER.price.label, note: "Le forfait couvre la préparation, l’atelier de travail, le plan validé, la mise en place et la transmission. Les licences et consommations d’outils restent séparées." },
        included: ["Analyse du fonctionnement actuel", "Plan de mise en place validé", "Organisation des informations et des responsabilités", "Mise en place des outils et automatisations retenus", "Tests, ajustements et transmission"],
      },
    ],
    cta: callback,
    included: ["Préparation et atelier de travail", "Plan de mise en place validé", "Organisation et mise en place des éléments retenus", "Tests, ajustements et transmission à l’équipe"],
