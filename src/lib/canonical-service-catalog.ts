...
const canonicalServiceDefinitions = deepFreeze([
  ...
  },
  {
    ...
    summary: "Mettez de l’ordre dans votre entreprise et des systèmes pour que ça dure.",
    description: "Nous clarifions votre fonctionnement puis mettons en place les systèmes opérationnels prioritaires définis avec vous, à partir de vos outils actuels.",
    result: "Des systèmes documentés et utilisables pour que les demandes, les documents et les tâches avancent sans reposer entièrement sur le dirigeant.",
    delivery: "demaa",
    pricing: null,
    packages: [
      {
        ...
        included: ["Analyse du fonctionnement actuel", "Définition du périmètre prioritaire", "Conception et mise en place des systèmes", "Configuration des outils et automatisations nécessaires", "Tests, documentation et formation"],
      },
    ],
    cta: callback,
    included: ["Préparation et atelier de travail", "Définition du périmètre prioritaire", "Conception et mise en place", "Tests, documentation et transmission à l’équipe"],
