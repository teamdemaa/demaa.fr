...
const canonicalServiceDefinitions = deepFreeze([
  ...
  {
    slug: "recruter-un-alternant", name: "Recruter un alternant", eyebrow: "Alternance · association partenaire",
    detailHref: "/services/recruter-un-alternant", packages: [],
    summary: "Recrutez un alternant déjà formé et accompagné, correspondant aux fonctions proposées par notre association partenaire.",
    description: "Demaa recueille votre besoin et le transmet à l’association partenaire. Elle identifie les profils déjà formés et accompagnés, puis organise la mise en relation avec votre entreprise.",
    result: "Des profils d’alternants préparés à leur entrée en entreprise, à étudier sans frais de mise en relation.",
    delivery: "third-party",
    pricing: { mode: "fixed", amountMinor: 0, currency: "EUR", heading: "Tarif", label: "Gratuit", note: "La demande, la présentation des profils et l’accompagnement par l’association partenaire sont gratuits. Aucun paiement n’est déclenché." },
    cta: callback,
    included: ["Profil commercial", "Profil administratif polyvalent", "Profil montage vidéo ou création de contenu"],
    conditions: ["Les profils dépendent des disponibilités de l’association", "L’association confirme l’adéquation du profil avec le besoin", "Vous restez libre de poursuivre le recrutement"],
    ...
    packages: [
      {
        ...
        pricing: { mode: "fixed", amountMinor: AUTOMATION_OFFER.price.amountMinor, currency: AUTOMATION_OFFER.price.currency, heading: "Tarif", label: AUTOMATION_OFFER.price.label, note: `Le tarif couvre l’analyse, les points réguliers et la mise en place progressive. ${AUTOMATION_OFFER.commitmentLabel} Les licences et consommations d’outils restent séparées.` },
        included: ["Diagnostic initial", "Priorités de structuration", "Mise en place progressive", "Points de travail réguliers", "Tests, documentation et prise en main"],
      },
    ],
    cta: callback,
    included: ["Analyse du fonctionnement", "Choix et construction de l’automatisation prioritaire", "Connexion avec les outils", "Tests, documentation et prise en main"],
