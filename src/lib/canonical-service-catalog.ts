...
const canonicalServiceDefinitions = deepFreeze([
  ...
  },
  {
    ...
    summary: "Gagnez du temps avec l’automatisation et l’IA.",
    ...
    result: "Une organisation plus fluide, des automatisations utiles et une équipe plus autonome pour les faire évoluer.",
    delivery: "demaa",
    pricing: null,
    packages: [
      {
        ...
        pricing: { mode: "fixed", amountMinor: AUTOMATION_OFFER.price.amountMinor, currency: AUTOMATION_OFFER.price.currency, heading: "Forfait", label: AUTOMATION_OFFER.price.label, note: "Le programme couvre une entreprise, quatre rendez-vous d’une heure et douze mois d’accès aux tutoriels. Les licences et consommations d’outils restent séparées." },
        included: ["Quatre rendez-vous d’une heure avec un mentor", "Priorités définies au fil de l’accompagnement", "Mise en pratique entre les rendez-vous", "Tutoriels pratiques accessibles pendant douze mois"],
      },
    ],
    cta: callback,
    included: ["Quatre rendez-vous d’une heure avec un mentor", "Priorités définies au fil de l’accompagnement", "Mise en pratique entre les rendez-vous", "Tutoriels pratiques accessibles pendant douze mois"],
