...
export const toolsData: ServiceRecord[] = [
  { id: "t2", slug: "generation-de-qr-code-pour-card", name: "Carte de Visite QR Code WhatsApp", category: "Outils visuels", description: "Créez facilement des QR codes optimisés pour vos cartes de visite.", shortDescription: "Pour carte de visite", tags: ["QR", "Card"], icon: "QrCode", price: "Gratuit" },
