        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 pt-10 md:gap-8 md:pt-14">
          ...
          <PrivacySection title="2. Données collectées">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>données d&apos;inscription aux offres partenaires : prénom, secteur d&apos;activité et adresse email ;</li>
          ...
          <PrivacySection title="3. Finalités et bases juridiques">
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li><strong>Envoyer les tarifs négociés et offres partenaires Demaa :</strong> consentement, avec possibilité de se désinscrire à tout moment.</li>
