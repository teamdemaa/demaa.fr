    ...
    >
      ...
      <PrivacySection title="4. Outils et destinataires">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li><strong>Google Firebase / Firestore</strong> pour le stockage sécurisé des demandes, des plans que vous choisissez de sauvegarder, des conversations avec un spécialiste, de leur contexte d&apos;attribution et des compteurs agrégés d&apos;ouverture des systèmes ;</li>
