    ...
    >
      ...
      <PrivacySection title="3. Finalités et bases juridiques">
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li><strong>Enregistrer et retrouver vos plans :</strong> exécution du service demandé. Le plan généré est révélé après la création ou la reprise de votre accès par e-mail et mot de passe ou par Google, puis enregistré automatiquement dans votre entreprise par défaut avec ses modifications. Un plan vierge peut être préparé avant connexion, mais n&apos;est sauvegardé qu&apos;après une première modification utile et l&apos;authentification. Demaa ne reçoit ni ne conserve votre mot de passe, géré par Firebase Authentication.</li>
