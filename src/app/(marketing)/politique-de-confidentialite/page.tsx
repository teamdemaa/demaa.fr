    ...
    >
      ...
      <PrivacySection title="2. Données collectées">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>adresse e-mail et critères de recherche enregistrés lorsque vous créez une alerte pour les entreprises à reprendre ;</li>
      ...
      <PrivacySection title="3. Finalités et bases juridiques">
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li><strong>Vous envoyer les nouvelles entreprises correspondant à une alerte de reprise :</strong> exécution du service demandé. Chaque message permet de modifier ou supprimer l&apos;alerte sans créer de compte.</li>
      ...
      <PrivacySection title="5. Durée de conservation">
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li><strong>Alerte de reprise :</strong> l&apos;adresse email et les critères sont conservés tant que l&apos;alerte est active, puis supprimés lorsque vous supprimez l&apos;alerte.</li>
