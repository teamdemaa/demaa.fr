    ...
    >
      ...
      <PrivacySection title="2. Données collectées">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>contenu transmis à l&apos;assistant IA et plans générés ; après création de votre accès, chaque plan sauvegardé est rattaché à une entreprise technique par défaut, elle-même reliée à votre identifiant Firebase par une appartenance active ;</li>
      ...
      <PrivacySection title="3. Finalités et bases juridiques">
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li><strong>Fournir l&apos;assistant IA :</strong> exécution du service demandé ; avant authentification, seul le texte que vous avez saisi et un identifiant technique de demande peuvent être conservés temporairement dans la session du navigateur. Aucun contenu généré n&apos;est créé avant votre authentification.</li>
              <li><strong>Enregistrer et retrouver vos plans :</strong> exécution du service demandé. Après la création ou la reprise de votre accès par e-mail et mot de passe ou par Google, Demaa crée le plan dans votre entreprise par défaut avec un état de génération, enregistre le résultat lorsqu&apos;il est prêt et conserve ses modifications. Une génération interrompue peut être reprise sans créer de doublon. Un plan vierge peut être préparé avant connexion, mais n&apos;est sauvegardé qu&apos;après une première modification utile et l&apos;authentification. Demaa ne reçoit ni ne conserve votre mot de passe, géré par Firebase Authentication.</li>
      ...
      <PrivacySection title="8. Cookies, traceurs et stockage local">
            <p>
              Le site utilise des outils de mesure d&apos;audience et des traceurs marketing selon vos choix. Avant authentification, le texte saisi pour demander un plan et un identifiant technique peuvent être conservés dans la session du navigateur pendant 2 heures au maximum ; aucun plan n&apos;est alors généré ou stocké dans le navigateur. Un brouillon de proposition d&apos;opportunité peut également être conservé temporairement dans cette session afin d&apos;éviter sa perte pendant la connexion ; il est supprimé après la soumission.
            </p>
            <p>
