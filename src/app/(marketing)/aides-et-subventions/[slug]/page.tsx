          ...
          <div className="mx-auto max-w-6xl">
            ...
            <section className="mt-5">
              <RelatedSystemsLinks
                ...
                description="Quelques systèmes métier où cette famille d'aides peut être utile."
              />
            </section>
          </div>
        </main>
      ...
      <main className="flex-1 w-full bg-dema-cream px-4 py-8 md:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <section className="mt-5">
            <RelatedSystemsLinks
              systems={relatedSystems}
              description="Quelques systèmes métier où ce sujet d'aide ou de subvention peut être pertinent."
            />
          </section>
        </div>
      </main>
