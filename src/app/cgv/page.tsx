...
export default function CgvPage() {
  return (
    <LegalPageLayout
      ...
      titleAccent="vente"
      description="Ces CGV encadrent les prestations et offres commerciales proposées par Demaa, notamment les missions d’automatisation, audits et crédits d’automatisation."
    >
