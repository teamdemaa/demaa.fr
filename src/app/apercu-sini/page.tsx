    ...
    <div lang={locale} className="min-h-screen bg-[#faf8f4] font-sans text-[#262822] [&_a:focus-visible]:outline-2 [&_a:focus-visible]:outline-offset-4 [&_a:focus-visible]:outline-[#536653]">
      ...
      <main>
        ...
        <section className="grid bg-white lg:grid-cols-2">
          <div className="relative min-h-[420px] overflow-hidden bg-[#817060] lg:min-h-[620px]"><Image src="/sini-preview/coast.png" alt={t.approachImageAlt} fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover object-center" /><div aria-hidden="true" className="absolute inset-0 bg-gradient-to-t from-[#171b17]/75 via-transparent to-transparent" /><p className="absolute bottom-9 left-7 max-w-md font-serif text-4xl leading-[1.05] tracking-[-0.04em] text-white md:bottom-12 md:left-12 md:text-5xl">{t.approachImageQuote}</p></div>
        ...
        <section className="relative min-h-[350px] overflow-hidden bg-[#34352c] px-5 py-20 text-white md:px-10 lg:min-h-[430px] xl:px-16"><Image src="/sini-preview/architecture.png" alt="" fill sizes="100vw" className="object-cover object-center" /><div aria-hidden="true" className="absolute inset-0 bg-[#25291f]/55" /><div className="relative mx-auto flex min-h-[210px] max-w-[1312px] flex-col justify-end"><h2 className="max-w-[780px] font-serif text-[clamp(2.7rem,5vw,5.2rem)] leading-[1.03] tracking-[-0.05em]">{t.banner}</h2><div className="mt-8 h-px w-14 bg-white/80" /><span className="mt-5 text-xs font-medium tracking-[0.25em]">SINI</span></div></section>
